    ...
    <div class="container-fluid">
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-7">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Cambio de rodamientos</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan43"><i class="fas fa-check"></i></h5>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Inspección de resistencia eléctrica (si aplica)</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            ...
            <div class="row col-9">
                <div class="col-4 hf-41"></div>
                <div class="col-4 hf-41"></div>
                <div class="col-4 hf-41">
                    <div class="row">
                        <div class="col-6 tx-center tx-18">Alta</div>
                        <div class="col-6 tx-center tx-18">Baja</div>
                    </div>
                </div>

                <div class="col-4 hf-41"></div>
                <div class="col-4 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-top:1px solid;border-bottom">
                    <h5 class="tx-18 tx-center tx-medium">Mediciones de Velocidad de Aire (m/s)</h5>
                </div>
                <div class="col-4 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41"
                            style="border-right:solid 1px;border-top:1px solid" id="a1"></div>
                        <div class="col-6 tx-center tx-medium tx-18 hf-41"
                            style="border-right:solid 1px;border-top:1px solid" id="b1"></div>
                    </div>
                </div>
                ...
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Motor 1</div>
                ...
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Motor 2</div>
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-12">
                ...
                <div class="col-12"
                    style="border-left: solid 1px;border-bottom: solid 1px; border-right:solid 1px;height:120px">
                </div>
            </div>
        </div>
        <!-- FECHA MANTENCION -->
