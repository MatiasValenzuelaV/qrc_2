        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-7">
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Chequeo de temperatura de Compresor</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Chequeo de Luces Interiores</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Funcionamiento de termostato de gabinete</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Funcionamiento de termostato de cooler</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan42"><i class="fas fa-check"></i></h5>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Chequeo de estado de burletes</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan43"><i class="fas fa-check"></i></h5>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza de serpentín (Condensador)</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza de bandeja de condensado</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Reapriete de bornera de motor</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-3">
                ...
                <div class="col-10 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" style="border-right:solid 1px;">Gabinete
                        </div>
                ...
                <div class="col-10 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" style="border-right:solid 1px;">Freezer
                        </div>
            ...
            <div class="row col-9">
                <div class="col-12 hf-41"></div>
                <div class="col-4 tx-center hf-41"></div>
                <div class="col-2 tx-center hf-41"></div>
                <div class="col-6 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-top:1px solid;border-bottom">
                    <h5 class="tx-18 tx-center tx-medium">Medición de Consumos Eléctricos (A)</h5>
                </div>
                <div class="col-4 tx-center tx-medium tx-18 hf-41"></div>
                <div class="col-2 tx-right tx-medium tx-18 hf-41"></div>
                <div class="col-6 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" style="border-right:solid 1px;">L</div>
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" style="border-right:solid 1px;">Nominal</div>
                    </div>
                </div>
                <div class="col-4 tx-center tx-medium tx-18 hf-41"></div>
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Compresor</div>
                <div class="col-6 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" id="nom1" style="border-right:solid 1px;">
                        </div>
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" id="nominal1"
                            style="border-right:solid 1px;"></div>
                    </div>
                </div>
                <div class="col-4 tx-center tx-medium tx-18 hf-41"></div>
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Ventilador</div>
                <div class="col-6 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" id="nom4" style="border-right:solid 1px;">
                        </div>
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" id="nominal2"
                            style="border-right:solid 1px;"></div>
                    </div>
                </div>
            </div>
...
function GetDataOT(idOT) {
    $.ajax({
        ...
        success: data => {
            ...
            let nombre_equipo = ''
            if (equ_nombre == 'Congelador') {
                nombre_equipo = 'FREEZER'
            } else {
                nombre_equipo = equ_nombre
            }
            $("#EQU").html(nombre_equipo);
