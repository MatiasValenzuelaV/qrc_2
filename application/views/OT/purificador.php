    ...
    <div class="container-fluid">
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-7">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza/cambio de filtro</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza de sensores</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Inspección de lonas y aislación (si aplica)</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan43"><i class="fas fa-check"></i></h5>
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            ...
            <div class="row col-9">
                <div class="col-6 hf-41"></div>
                <div class="col-3 tx-center tx-18 hf-41">L</div>
                <div class="col-3 tx-center tx-18 hf-41">Nominal</div>
                ...
                <div class="col-3 tx-center tx-medium tx-18 hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-top:1px solid"
                    id="nom1">
                </div>
                <div class="col-3 tx-center tx-medium tx-18 hf-41"
