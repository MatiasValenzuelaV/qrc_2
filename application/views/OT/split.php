    ...
    <div class="container-fluid">
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-7">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza rejilla(s) de extracción</h5>
                </div>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza de Condensador</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Limpieza de Evaporador</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Revisión y limpieza de componentes eléctricos</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Reapriete de borneras de motor</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan58"><i class="fas fa-check"></i></h5>
                ...
                <div class="col-7 hf-41">
                    <h5 class="tx-18 tx-medium">Inspección visual de filtración de gas refrigerante</h5>
                </div>
                <div class="col-3 hf-41 tx-centertx-center bd-x-1 bd-b-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;">
                    <h5 class="tx-18 tx-center tx-medium" id="fan58"><i class="fas fa-check"></i></h5>
        ...
        <div class="row tx-black mg-t-100 mg-b-70">
            <div class="row col-3">
                <div class="col-12 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"></div>
                <div class="col-12 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"></div>
                <div class="col-10 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"
                ...
                <div class="col-10 hf-41 tx-center bd-x-1 bd-b-1 bd-t-1"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid">
                    <div class="row">
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" style="border-right:solid 1px;">Retorno</div>
                        <div class="col-6 tx-center tx-medium tx-18 hf-41" id="retorno"></div>
                    </div>
                </div>
            </div>
            <div class="row col-9">
                ...
                <div class="col-1 tx-center hf-41"></div>
                <div class="col-8 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-top:1px solid;border-bottom">
                    <h5 class="tx-18 tx-center tx-medium">Medición de Consumos Eléctricos (A)</h5>
                </div>
                <div class="col-2 tx-center tx-medium tx-18 hf-41"></div>
                ...
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Ventilador Exterior</div>
                ...
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Ventilador Interior</div>
                ...
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Compresor 1</div>
                <div class="col-1 tx-center tx-medium tx-18 hf-41" id="t3" style="border:solid 1px"></div>
                <div class="col-1 tx-center tx-medium tx-18 hf-41" id="m3"
                    style="border-top:solid 1px;border-bottom:solid 1px">
                </div>
                <div class="col-8 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom7" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom8" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom9" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nominal3"></div>
                    </div>
                </div>
                <div class="col-2 tx-right tx-medium tx-18 hf-41">Compresor 2</div>
                <div class="col-1 tx-center tx-medium tx-18 hf-41" id="t5" style="border:solid 1px"></div>
                <div class="col-1 tx-center tx-medium tx-18 hf-41" id="m6"
                    style="border-top:solid 1px;border-bottom:solid 1px">
                </div>
                <div class="col-8 tx-center hf-41"
                    style="border-left:solid 1px;border-right:solid 1px;border-bottom:1px solid;border-bottom">
                    <div class="row">
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom10" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom11" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nom12" style="border-right:solid 1px;">
                        </div>
                        <div class="col-3 tx-center tx-medium tx-18 hf-41" id="nominal4"></div>
                    </div>
                </div>
            </div>
        </div>
...
function GetDataOT(idOT) {
    $.ajax({
        ...
        success: data => {
            ...
            if (parseFloat(calor) > 0) {
                $("#calor").html(parseFloat(calor));
            }
            if (parseFloat(frio) > 0) {
            ...
            if (m3 > 0) {
                $("#m3").html('<i class="fas fa-check"></i>');
            }
            if (t3 > 0) {
                $("#t3").html('<i class="fas fa-check"></i>');
            }
            //AIRE
            if (a1 > 0) {
