    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-4" style="float:left">
                <img src="https://qrc.acbingenieria.cl/assets/img/QRC-LOGO.jpg" style="-webkit-filter: grayscale(100%);filter: grayscale(100%);" alt="log" class="img-fluid" height="40%" width="40%">
            </div>
            <div class="col-4 tx-center mg-t-35">
                <h3 class="tx-bold tx-black">ORDEN DE TRABAJO</h3>
            </div>
            <div class="col-3 tx-right">
                <h5 class="tx-12 tx-bold tx-black">FOLIO

                </h5>
            </div>
            <div class="col-1 tx-left">
                <h5 class="tx-12 tx-bold tx-black tx-center" id="numOT" style="border:solid 2px">
                    N° 84
                </h5>
            </div>
        </div>
        <div class="row tx-black mg-t-20" style="border:solid 2px">
            <div class="row col-5 mg-20">
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Equipo:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="EQU">Unidad Manejadora De Aire</h5>
                </div>
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Ubicación:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="UBI">Sector Anillo P6°Clinica</h5>
                </div>
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Descripción:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="DES">Uma 02 Pabellón N°13</h5>
                </div>
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Marca:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="MAR">INTERCAL</h5>
                </div>
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Modelo:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="MOD">MA03-28-21-23-0-H</h5>
                </div>
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Serie:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="SER">10860.1.1.1</h5>
                </div>
            </div>
            <div class="row col-5 mg-20">
                <div class="col-4">
                    <h5 class="tx-14 tx-bold">N° De Activo:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="ACT">50-2813-1</h5>
                </div>

                <div class="col-4">
                    <h5 class="tx-14 tx-bold"></h5>
                </div>
                <div class="col-8 tx-center">
                    <h5 class="tx-14 tx-center tx-bold">&nbsp&nbsp&nbsp</h5>
                </div>

                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Cliente:</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold" id="CLI">CAS</h5>
                </div>

                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Periodo Ejecución</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px;padding-bottom:3px">
                    <h5 class="tx-14 tx-center tx-bold" id="mes">Abril, 2021</h5>
                </div>

                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Area</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
                    <h5 class="tx-14 tx-center tx-bold"></h5>
                </div>

                <div class="col-4">
                    <h5 class="tx-14 tx-bold">Mantención preventiva</h5>
                </div>
                <div class="col-8 tx-center" style="border:solid 1px">
        ...
        <div class="row tx-black mg-t-20" style="border:solid 2px">
            ...
            <div class="row col-7">
                <table class="table" id="contentCheckTable">
                    <thead class="">
                        <tr>
                            <th class="tx-center tx-13" style="height:62.5px">Vrv</th>
                            <th class="tx-center tx-13" style="height:62.5px">Fan Coil</th>
                            <th class="tx-center tx-13" style="height:62.5px">VEX</th>
                            <th class="tx-center tx-13" style="height:62.5px">Compacto</th>
                            <th class="tx-center tx-13" style="height:62.5px">Split</th>
                            <th class="tx-center tx-13" style="height:62.5px">Ventana</th>
                            <th class="tx-center tx-13" style="height:62.5px">UMA</th>
                            <th class="tx-center tx-13" style="height:62.5px">M. Split</th>
                            <th class="tx-center tx-13" style="height:62.5px">Chiller</th>
                            <th class="tx-center tx-13" style="height:62.5px">Cortina</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
        ...
        <div class="row tx-black" style="border-bottom:solid 2px;border-left:solid 2px;border-right:solid 2px">
            <div class="row col-12">
                <div class="col-8">
                    <h5 class="mg-l-30 mg-t-10 tx-16 tx-bold">EQUIPOS</h5>
                </div>
                <div class="col-2 tx-16">
                    Presión
                </div>
                <div class="col-2 tx-16">
                    Temperatura
            ...
            <div class="row col-12 mg-b-30">
                <div class="col-7 mg-b-10" style="border-top:solid 2px;border-bottom:solid 2px;border-right:solid 2px">
                    <div class="row">
                        <div class="col-3 tx-center" style="border-right:solid 2px">
                            <h5 class="tx-center mg-t-100">CHILLER</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16 mg-b-30">CHEQUEO DE PRESION Y TEMPERATURA AGUA</h5>
                            <div class="">&nbsp&nbsp&nbsp</div>
                            <h5 class="tx-16">MEDICIONES DE CONSUMO VENT. CONDENSADOR 1</h5>
                            <h5 class="tx-16">MEDICIONES DE CONSUMO VENT. CONDENSADOR 2</h5>
                            <h5 class="tx-16">MEDICIONES DE CONSUMO COMPRESOR 1</h5>
                            <h5 class="tx-16">MEDICIONES DE CONSUMO COMPRESOR 2</h5>
                            <h5 class="tx-16">MEDICIONES DE CONSUMO BOMBA DE AGUA</h5>
                            <h5 class="tx-16">PRESION DE REGRIGERANTE COMPRESOR 1 (si procede)</h5>
                            <h5 class="tx-16">PRESION DE REGRIGERANTE COMPRESOR 2 (si procede)</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mg-b-30">&nbsp&nbsp&nbsp</div>
                                    <h5 class="tx-16 tx-center">Trif</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                ...
                                <div class="col-6">
                                    <div class="mg-b-30">&nbsp&nbsp&nbsp</div>
                                    <h5 class="tx-16 tx-center">Mono</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                                    <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                ...
                <div class="col-4">
                    <div class="row">
                        <div class="col-3">
                            <h5 class="tx-16 tx-center">Entrada</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">R</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">Baja</h5>
                            <h5 class="tx-16 tx-center">Baja</h5>
                        </div>
                        <div class="col-3">
                            <h5 class="tx-16 tx-center">Salida</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">S</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                        ...
                        <div class="col-3">
                            <h5 class="tx-16 tx-center">Entrada</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">T</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">Alta</h5>
                            <h5 class="tx-16 tx-center">Alta</h5>
                        </div>
                        <div class="col-3">
                            <h5 class="tx-16 tx-center">Salida</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16 tx-center">Nom.</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                            <h5 class="tx-16" style="border:solid 1px">&nbsp</h5>
                ...
                <div class="col-1">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="tx-16 tx-center">PSI/°C</h5>
                            <div class="mg-b-35">&nbsp&nbsp&nbsp</div>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">PSI/°</h5>
                            <h5 class="tx-16 tx-center">PSI/°</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row col-12">
                <div class="col-5">
                    <h5 class="mg-l-30 mg-t-10 tx-16 tx-bold"></h5>
                </div>
                <div class="col-1 tx-center tx-16">
                    Trif
                </div>
                <div class="col-1 tx-center tx-16">
                    Mono
                ...
                <div class="col-7 mg-b-10" style="border-top:solid 2px;border-bottom:solid 2px;border-right:solid 2px">
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">M.Split</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE CONSUMO VENT.EXTERIOR</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="tx-18 tx-bold tx-center" id="11" style="border-right:solid 1px;border-left:solid 1px;border-bottom:solid 1px;">&nbsp</h5>
                                </div>
                                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Split</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE CONSUMO VENT.INTERIOR</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Comp</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE CONSUMO COMPRESOR</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Ventana</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">PRESION DE REFRIGERANTE (si procede)</h5>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="border-right:solid 2px">
                            <h5 class="tx-16">Vrv UI</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">CHEQUEO DE TEMPERATURAS DE INYECCIÓN</h5>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="row">
                        <div class="col-3">
                            ...
                            <h5 class="tx-16 tx-bold tx-center">Baja</h5>
                            <h5 class="tx-16 tx-bold tx-center">Frío</h5>
                        ...
                        <div class="col-3">
                            ...
                            <h5 class="tx-16 tx-bold tx-center">Calor</h5>
                        ...
                        <div class="col-3">
                            ...
                            <h5 class="tx-16 tx-bold tx-center">Alta</h5>
                            <h5 class="tx-16 tx-bold tx-center">&nbsp&nbsp</h5>
                            <h5 class="tx-16 tx-bold tx-center">Cº</h5>
                        </div>
                        <div class="col-3">
                ...
                <div class="col-1">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">PSI/°G</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row col-12">
                <div class="col-7 mg-b-10" style="border-top:solid 2px;border-bottom:solid 2px;border-right:solid 2px">
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Uma</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE CONSUMO ELECTRICO MOTOR 1<h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="tx-18 tx-center tx-bold" id="21" style="border-right:solid 1px;border-left:solid 1px;border-bottom:solid 1px;">&nbsp</h5>
                                </div>
                                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE CONSUMO ELECTRICO MOTOR 2</h5>
                        </div>
                        <div class="col-3">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="tx-16 tx-center tx-bold" id="2t2" style="border:solid 1px">&nbsp</h5>
                                </div>
                                <div class="col-6">
                                    <h5 class="tx-16 tx-center tx-bold" id="2m2" style="border:solid 1px">&nbsp</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Fan Coil</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">MEDICIONES DE VELOCIDAD DEL AIRE (mts/seg)</h5>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Vex / Vin</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">TEMPERATURA CARCASA MOTOR (Fancoil)</h5>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-2" style="border-bottom:solid 2px;border-right:solid 2px">
                            <h5 class="tx-16">Cortina de aire</h5>
                        </div>
                        <div class="col-6">
                            <h5 class="tx-16">CHEQUEO DE TEMPERATURAS DE INYECCIÓN</h5>
                        </div>
                ...
                <div class="col-4">
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <h5 class="tx-18 tx-center">&nbsp&nbsp&nbsp</h5>
                            <h5 class="tx-16 tx-center">Frío/Calor</h5>
                        </div>
                        <div class="col-3">
                            ...
                            <h5 class="tx-16 tx-center">A/M/B</h5>
                ...
                <div class="col-1">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">Amp</h5>
                            <h5 class="tx-16 tx-center">&nbsp&nbsp</h5>
                            <h5 class="tx-16 tx-center">°C</h5>
                            <h5 class="tx-16 tx-center">°C</h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="row tx-black" style="border-bottom:solid 2px;border-left:solid 2px;border-right:solid 2px">
            <h5 class="mg-l-30 tx-14">Observaciones:</h5>
        ...
        <div class="row tx-black" style="border-bottom:solid 2px;border-left:solid 2px;border-right:solid 2px">
            <div class="row col-12">
                <div class="col-2">
                    <div class="mg-t-20">
                        <h5 class="tx-14">Fecha Inicio:</h5>
                    </div>
                </div>
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="fechaMan">04-02-2021</h5>
                    </div>
                </div>
            </div>
            <div class="row col-12">
                <div class="col-2">
                    <div class="mg-t-20">
                        <h5 class="tx-14">Técnico 1:</h5>
                    </div>
                </div>
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="tecnico">MIGUEL ANGEL DELGADO GOMEZ</h5>
                    </div>
                </div>
                <div class="col-2">
                    <div class="mg-t-20">
                        <h5 class="tx-14">Técnico 2:</h5>
                    </div>
                </div>
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="ayudante">YOHANSSON HENRRITO ALVARES</h5>
                    </div>
                </div>
            </div>
            <div class="row col-12 mg-t-50">
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="imgFIRMAT"></h5>
                        <h5 class="tx-center tx-14">Firma Técnico</h5>
                    </div>
                </div>
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="imgFIRMAS"></h5>
                        <h5 class="tx-center tx-14">V° B° Supervisor QR Cleaner Ingeniería</h5>
                    </div>
                </div>
                <div class="col-4">
                    <div class="mg-t-20">
                        <h5 class="tx-14 tx-center tx-bold" style="border-bottom:solid 2px" id="imgFIRMAC"></h5>
                        <h5 class="tx-center tx-14">V° B° Responsable Clínica</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    function listado() {
        $.ajax({
            ...
            success: (data) => {
                ...
                $("#fechaMan").html(moment(json[0].fecha_registro).format('DD-MM-YYYY'));
    ...
    function check_listado() {
        $.ajax({
            ...
            success: data => {
                ...
                let html = ``;
                json.map(d => {
                    html += `<div class="col-12 tx-14 tx-black">${d.chk_nombre}</div>`
                })
