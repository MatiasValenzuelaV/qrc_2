                            ...
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-10">
                                        <input id="frmEquipos" maxlength="50" type="text" placeholder="Ingrese nombre equipo a buscar." class="form-control form-control-success">
                                    </div>
                                </div>
                            </form>
                        </div>
...
<div id="mdlEquipos" class="modal fade" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-vertical-center modal-md" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold" id="titleEquipos"></h6>
            ...
            <div class="modal-body pd-25">
                ...
                <div class="row mg-b-5">
                    <input type="text" class="d-none" id="txtEquid">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="form-control-label">Nombre Equipo: </label>
                            <input class="form-control" type="text" name="txtEqunombre" id="txtEqunombre" placeholder="Ingrese nombre equipo">
                        </div>
                    </div>
                </div>
            </div>
...
<div id="mdlCheckListEquipos" class="modal fade" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold" id="titleChecklistEquipos"></h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body pd-25">
                ...
                <div class="row mg-b-5">
                    <div class="card-body">
                        <input type="text" class="d-none" id="txtEquidC">
                        <table class="table table-responsive table-striped" id="tblEquiposC">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Nombre</th>
                            ...
                            <tbody id="tbodyEquiposC">
                            </tbody>
                        </table>
                        <!-- <nav id="registros-pagina2" class="d-none mg-t-30">
                            <ul class="pagination d-flex justify-content-center pagination-sm"></ul>
                        </nav> -->
                    </div>
...
<div id="mdlInsumosEquipos" class="modal fade" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold" id="titleInsumosEquipos"></h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body pd-25">
                ...
                <div class="row mg-b-5">
                    <div class="card-body">
                        ...
                        <table class="table table-responsive table-striped" id="tblEquiposI">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Nombre</th>
                            ...
                            <tbody id="tbodyEquiposI">
                            </tbody>
                        </table>
                        <!-- <nav id="registros-pagina3" class="d-none mg-t-30">
                            <ul class="pagination d-flex justify-content-center pagination-sm"></ul>
                        </nav> -->
                    </div>
...
<script src="<?= js_url(); ?>app/equipos.js"></script>