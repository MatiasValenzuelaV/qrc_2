                        ...
                        <div class="card-body">
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-lg-2 form-control-label">Cargo</label>
                                    <div class="col-sm-12 col-lg-10">
                                        <input id="frmCargo" maxlength="50" type="text" placeholder="Ingrese nombre de cargo a buscar." class="form-control form-control-success">
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card bd-0">
                        <div class="card-header bg-primary  d-flex align-items-center justify-content-between pd-y-5 tx-uppercase">
                            <h7 class="mg-b-0 tx-14 tx-white tx-normal">Cargos registrados</h7>
                            ...
                            <table class="table table-responsive table-striped" id="ttable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tx-center">Editar</th>
                                        <th class="tx-center">Eliminar</th>
                                    </tr>
                                </thead>
                                <tbody id="tbody">
                                </tbody>
...
<div id="mdlNuevo" class="modal fade" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold" id="titleNuevo"></h6>
                ...
                <div class="row mg-b-5">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="txtCargo" id="txtCargo" placeholder="Ingrese nombre del nuevo cargo...">
                        </div>
                    </div>
                </div>
            </div>
