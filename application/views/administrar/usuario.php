                            ...
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-10">
                                        <select class="form-control select2" id="frmPerfil" data-placeholder="Choose Browser">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-10">
                                        <input id="frmPersonal" maxlength="50" type="text" placeholder="Ingrese el nombre de la persona que desea buscar." class="form-control form-control-success">
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row mg-b-5">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group col-lg-12">
                            ...
                            <input class="form-control" type="text" name="mfrmRut" disabled id="mfrmRut" placeholder="Rut de la persona">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group col-lg-12">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group col-sm-12">
                            ...
                            <input class="form-control" type="text" name="mfrmUsuario" id="mfrmUsuario" placeholder="Nombre del usuario">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6" id="frmClave">
                        <div class="form-group col-lg-12">
                            ...
                            <input class="form-control" type="password" name="mfrmClave" id="mfrmClave" placeholder="Clave de ingreso">
                        </div>
                    </div>
                    <div class="col-sm-6" id="frmClaveCon">
                        <div class="form-group col-lg-12">
                            <label class="form-control-label">Confirmar clave </label>
                            <input class="form-control" type="password" name="mfrmClaveCon" id="mfrmClaveCon" placeholder="Confirmar clave">
                        </div>
                    </div>
