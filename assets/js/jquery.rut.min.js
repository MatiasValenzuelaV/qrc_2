...
(function(e) {
	...
	function i(e) {
		return (
			e.type &&
			e.type.match(/^key(up|down|press)/) &&
			(e.keyCode == 8 ||
				e.keyCode == 16 ||
				e.keyCode == 17 ||
				e.keyCode == 18 ||
	...
	var t = { validateOn: "blur", formatOn: "blur", ignoreControlKeys: true };
	var l = {
		init: function(n) {
			if (this.length > 1) {
				...
				s.opts = e.extend({}, t, n);
				s.opts.formatOn &&
					s.on(s.opts.formatOn, function(e) {
						if (s.opts.ignoreControlKeys && i(e)) return;
						u(s, e);
					});
				s.opts.validateOn &&
					s.on(s.opts.validateOn, function(e) {
						a(s, e);
					});
			}
			return this;
